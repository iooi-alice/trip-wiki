      ...
      <div class="filter-search-container">
        <div class="filter">
          <select id="sortList" class="sort-list">
            ...
            <option value="cost"
            ${sortBy === 'cost' && 'selected'}>Cost</option>
            <option value="fun"
            ${sortBy === 'fun' && 'selected'}>Fun</option>
            <option value="safety"
            ${sortBy === 'safety' && 'selected'}>Safety</option>
            <option value="internet"
            ${sortBy === 'internet' && 'selected'}>Internet</option>
            <option value="air"
            ${sortBy === 'air' && 'selected'}>Air Quality</option>
            <option value="food"
            ${sortBy === 'food' && 'selected'}>Food</option>
          </select>
        </div>
        <div class="search">
